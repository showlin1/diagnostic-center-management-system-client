            ...
            <footer className="bg-white border-t">
                <div className="container px-6 py-12 mx-auto">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        <div className="sm:col-span-2">
                            ...
                            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                                ...
                                <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-blue-400 rounded-lg hover:bg-cyan-600 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                                    Subscribe
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <Link to={'/'} className="text-2xl text-blue-400 font-black cursor-pointer hover:text-cyan-600">Digital Diagnostic Center</Link>
